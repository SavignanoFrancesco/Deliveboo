        ...
        <div class="dish-categories">
            ...
            <div class="dish-categories-container" v-for='dish_category in dish_categories_assembled' v-if="">
                ...
                <div class="dish-cards-container">
                    ...
                    <div class="dish-card" v-for='(dish, index) in json_dishes'
                         v-if="dish.dish_category_name == dish_category && dish.visibility">
                ...
                <div class="info-box">
                  ...
                  <div class="cart-adder">
                                    ...
                                    <button type="button" name="button" class="btn btn-primary"
                                            @click='updateCart(dish, "subtract");piece += 1;'>
                                    ...
                                    <button type="button" name="button" class="btn btn-primary"
                                            @click='updateCart(dish, "add");piece += 1;'>
                                ...
                                <div class="dish-details">
                                    ...
                                    <div class="info-box">
                                        ...
                                        <div class="cart-adder">
                                            ...
                                            <button type="button" name="button" class="btn btn-primary"
                                                    @click='updateCart(json_dishes[modal_index], "subtract");piece += 1;'>
                                                <i class="fas fa-minus"></i>
                                            </button>
                                            ...
                                            <button type="button" name="button" class="btn btn-primary"
                                                    @click='updateCart(json_dishes[modal_index], "add");piece += 1;'>
                                                <i class="fas fa-plus"></i>
                                            </button>
